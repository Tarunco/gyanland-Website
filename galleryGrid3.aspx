<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="galleryGrid3.aspx.cs" Inherits="galleryGrid3" %>
				...
				<div class="container">
					<div class="isotope-wrap">
						...
						<div class="row featuredContainer">
							<div class="col-lg-4 col-sm-6 col-12 all branding illustrations">
							...
							<div class="col-lg-4 col-sm-6 col-12 all ui product">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all branding design">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all branding ui">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all design ui">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all product">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all branding ul">
								<div class="gallery-box-layout1">
									<div class="item-figure">
							...
							<div class="col-lg-4 col-sm-6 col-12 all branding">
								<div class="gallery-box-layout1">
									<div class="item-figure">
